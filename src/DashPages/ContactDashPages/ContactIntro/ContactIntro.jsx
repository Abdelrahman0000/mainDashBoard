...
export default function ContactIntro() {
  ...
  const Back = data?.data?.bacground;
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await fetch('https://bluedana.mass-fluence.com/api/update-background-contact', {
        method: 'POST',
        body: formData,
      });
      window.alert('Update successful!');
    } catch (error) {
      console.error('Error updating Contact intro:', error);
