...
export default function ProjectIntro() {
  ...
  const fetchData = async () => {
    const response = await fetch("https://bluedana.mass-fluence.com/api/all-projects-front");
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await fetch(' https://bluedana.mass-fluence.com/api/update-background-projects', {
        method: 'POST',
        body: formData,
      });
